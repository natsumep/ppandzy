...
function generateContent(name) {
    let content=`<h4 style="margin-bottom:20px;">给<span class="orange-text">${name}</span>一个人的❤</h4>`;
    name = `<b style="font-weight:500">♡${name}♡</b>`
...
export function getQinghua(n) {
    let name = n || "zy";
   
    return generateContent(name);
}
